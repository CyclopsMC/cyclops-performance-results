    ...
    "Integrated Crafting Network Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f6f52313a6174e0eaca515fa3b2f44007f72de1c",
          "message": "Rename the new part to the Enumerated Crafting Interface\n\nRenames the part throughout, not just its display name: the part id becomes\ninterface_crafting_enumerated, with the class, config properties, assets,\nadvancement, lang keys and tests following. Nothing has been released yet, so\nthe id can still be aligned with the name.\n\nThe new name is as wide as the one it replaces, so it ran into the settings\nbutton in the gui title again. The title now shrinks to fit the space before\nthat button, which also covers translations, whose lengths vary per locale.\nTitles that already fit, such as the regular crafting interface, render\nunchanged.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_01Bn8brBLvFiJsfnBHpwf8ZN",
          "timestamp": "2026-09-06T14:07:27Z",
          "tree_id": "420c455b82005d030fe6ea3486ea1a9321e5d5b3",
          "url": "https://github.com/CyclopsMC/IntegratedCrafting/commit/f6f52313a6174e0eaca515fa3b2f44007f72de1c"
        },
        "date": 1788704058305,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e2eef42eabd478900f7c0812aedc6abe8b9b2248",
          "message": "Apply suggestion from @rubensworks",
          "timestamp": "2026-09-06T16:17:51+02:00",
          "tree_id": "be11c4368cd34a1793f2e3739b735ad4ceb7e0ec",
          "url": "https://github.com/CyclopsMC/IntegratedCrafting/commit/e2eef42eabd478900f7c0812aedc6abe8b9b2248"
        },
        "date": 1788704406202,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5471ceadabeb662bda3b98b7adcbb46d686f5d97",
          "message": "Avoid a superscript that the game font does not carry\n\nThe advancement title used U+2074 for a superscript four. It renders, but not\nfrom the same place as the superscript two and three of the sibling\nadvancements: those live in the built-in glyph sheet, while U+2074 falls\nthrough to the unicode fallback font and comes out thinner and taller. The\nthree titles read as a set, so the odd one out was visible.\n\nThe title becomes \"Crafting to the Fourth\", which keeps the escalation but uses\nonly characters the built-in font carries. It was also the only entry in the\nfile written as a \\u escape rather than as literal UTF-8, so that is gone too.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_01Bn8brBLvFiJsfnBHpwf8ZN",
          "timestamp": "2026-09-06T14:27:22Z",
          "tree_id": "7d9145baa5563fec232229ee5c1e25eb89e930da",
          "url": "https://github.com/CyclopsMC/IntegratedCrafting/commit/5471ceadabeb662bda3b98b7adcbb46d686f5d97"
        },
        "date": 1788705023526,
        "tool": "customSmallerIsBetter",
        "benches": [
